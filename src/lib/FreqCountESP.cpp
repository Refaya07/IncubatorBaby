...
_FreqCountESP::_FreqCountESP() { mTimer = NULL; }

_FreqCountESP::~_FreqCountESP() { end(); }
...
void _FreqCountESP::beginExtTrig(uint8_t freqPin, uint8_t extTriggerPin, uint8_t freqPinIOMode,
                                 uint8_t extTriggerMode) {
...
uint8_t _FreqCountESP::available() { return sIsFrequencyReady; }
